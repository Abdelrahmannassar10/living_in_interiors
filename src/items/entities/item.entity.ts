...
export class Item {
  ...
  @ManyToOne(() => Brand, { nullable: true, onDelete: 'RESTRICT' }) @JoinColumn({ name: 'brand_id' }) brand!: Brand | null;
  @Column({ type: 'varchar', nullable: true, length: 500 }) description!: string | null;
  @Column({ type: 'varchar', nullable: true, length: 200 }) dimension!: string | null;
