...
export class TransactionsController {
  ...
  @Get()
  findAll(@Query() query: TransactionSearchDto) {
  ...
  transfer(
    ...
    return this.transactionsService.createTransfer(dto, request.user?.id);
  }
  ...
  sale(
    ...
    return this.transactionsService.createSale(dto, request.user?.id);
  }
  ...
  return(
    ...
    return this.transactionsService.createReturn(dto, request.user?.id);
  }
  @ApiOperation({
    summary: 'Stock adjustment (Increase/Decrease, reason required)',
  })
  @ApiCreatedResponse({ type: Transaction })
  ...
  adjustment(
    ...
    return this.transactionsService.createAdjustment(dto, request.user?.id);
  }
}
