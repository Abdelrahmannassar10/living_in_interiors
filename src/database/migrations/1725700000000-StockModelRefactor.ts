...
export class StockModelRefactor1725700000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "item_stocks" ("id" SERIAL NOT NULL, "qty_on_hand" integer NOT NULL DEFAULT '0', "qty_reserved" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "item_id" integer NOT NULL, "location_id" integer NOT NULL, CONSTRAINT "PK_item_stocks" PRIMARY KEY ("id"), CONSTRAINT "UQ_item_stock_item_location" UNIQUE ("item_id", "location_id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "item_stocks" ADD CONSTRAINT "FK_item_stocks_item" FOREIGN KEY ("item_id") REFERENCES "items"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "item_stocks" ADD CONSTRAINT "FK_item_stocks_location" FOREIGN KEY ("location_id") REFERENCES "locations"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "stock_before" jsonb`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "stock_after" jsonb`,
    );
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP COLUMN "qty_showroom_before", DROP COLUMN "qty_storage1_before", DROP COLUMN "qty_storage2_before", DROP COLUMN "qty_sold_before", DROP COLUMN "qty_showroom_after", DROP COLUMN "qty_storage1_after", DROP COLUMN "qty_storage2_after", DROP COLUMN "qty_sold_after"`,
    );
    await queryRunner.query(
      `ALTER TABLE "items" DROP COLUMN "qty_showroom", DROP COLUMN "qty_storage1", DROP COLUMN "qty_storage2"`,
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_quotation_details_quotation_id" ON "quotation_details" ("quotation_id")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "transactions" ALTER COLUMN "adjustment_reason" TYPE character varying(200) USING "adjustment_reason"::text`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."transactions_adjustment_reason_enum"`,
    );
    await queryRunner.query(`DROP INDEX "public"."IDX_audit_logs_created_at"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_quotation_details_quotation_id"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "items" ADD "qty_showroom" integer NOT NULL DEFAULT '0', ADD "qty_storage1" integer NOT NULL DEFAULT '0', ADD "qty_storage2" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "qty_showroom_before" integer, ADD "qty_storage1_before" integer, ADD "qty_storage2_before" integer, ADD "qty_sold_after" integer, ADD "qty_showroom_after" integer, ADD "qty_storage1_after" integer, ADD "qty_storage2_after" integer, ADD "qty_sold_before" integer`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP COLUMN "stock_before", DROP COLUMN "stock_after"`,
    );
